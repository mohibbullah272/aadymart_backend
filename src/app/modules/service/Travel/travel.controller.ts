...
class TravelController {
    ...
    async create(req: Request, res: Response, next: NextFunction) {
      try {
        ...
        const event = await TravelService.create(webData);
    ...
    async getAll(req: Request, res: Response, next: NextFunction) {
      try {
        const event = await TravelService.findAll();
    ...
    async getById(req: Request, res: Response, next: NextFunction) {
      try {
        const event = await TravelService.findById(req.params.id);
        if (!event) {
    ...
    async update(req: Request, res: Response, next: NextFunction) {
      try {
        ...
        const event = await TravelService.update(req.params.id, req.body);
        if (!event) {
          return ApiResponse.notFound(res, 'web service not found');
        }
    ...
    async delete(req: Request, res: Response, next: NextFunction) {
      try {
        const event = await TravelService.delete(req.params.id);
        if (!event) {
          return ApiResponse.notFound(res, 'web service not found');
        }
