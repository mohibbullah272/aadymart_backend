...
class ITController {
    ...
    async create(req: Request, res: Response, next: NextFunction) {
      try {
        ...
        const event = await ITService.create(webData);
    ...
    async getAll(req: Request, res: Response, next: NextFunction) {
      try {
        const event = await ITService.findAll();
    ...
    async getById(req: Request, res: Response, next: NextFunction) {
      try {
        const event = await ITService.findById(req.params.id);
        if (!event) {
    ...
    async update(req: Request, res: Response, next: NextFunction) {
      try {
        ...
        const event = await ITService.update(req.params.id, req.body);
        if (!event) {
          return ApiResponse.notFound(res, ' service not found');
        }
    ...
    async delete(req: Request, res: Response, next: NextFunction) {
      try {
        const event = await ITService.delete(req.params.id);
        if (!event) {
          return ApiResponse.notFound(res, 'service not found');
        }
  ...
  export default new ITController